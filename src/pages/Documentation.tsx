        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <Card className="mt-12 p-8 glass-effect border-primary/30 animate-slide-up">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">{t.docs.techSpecs.lifesupport}</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">{t.docs.techSpecs.energy}</h3>
                <ul className="space-y-2 text-muted-foreground">
