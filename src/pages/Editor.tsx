          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6 animate-slide-up" style={{animationDelay: '0.1s'}}>
              ...
              <Card className="p-6 glass-effect border-border/30">
                ...
                <Button 
                  onClick={generatePDF}
                  className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold mb-4 flex items-center justify-center gap-2"
                >
                ...
                <div className="pt-4 border-t border-border/50">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      ...
                      className="border-border/50 hover:bg-green-500/10 flex items-center justify-center gap-2"
                    >
                    ...
                    <Button
                      ...
                      className="border-border/50 hover:bg-blue-500/10 flex items-center justify-center gap-2"
                    >
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <Button
                      ...
                      className="border-border/50 hover:bg-blue-600/10 flex items-center justify-center gap-2"
                    >
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <Button
                      ...
                      className="border-border/50 hover:bg-blue-700/10 flex items-center justify-center gap-2"
                    >
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <Button
                    ...
                    className="w-full mt-2 border-border/50 hover:bg-pink-500/10 flex items-center justify-center gap-2"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
